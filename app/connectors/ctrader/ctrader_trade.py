'''"""This module defines classes related to CtraderTrade."""'''
import logging
...
class CtraderTrade(Trade):
    ...
    def _open_position(self: Any, symbol: str, size: float, direction: str, order_type: str, sl: float=None, tp: float=None, price: float=None, comment: str='', **kwargs) -> OrderResult:
