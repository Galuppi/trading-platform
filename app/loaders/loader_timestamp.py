'''"""This module provides functions including load_tester_setup."""'''
import os
...
TIMEFRAME_STEP_MAP = {TIMEFRAME_M1: timedelta(minutes=1), TIMEFRAME_M5: timedelta(minutes=5), TIMEFRAME_M15: timedelta(minutes=15), TIMEFRAME_M30: timedelta(minutes=30), TIMEFRAME_H1: timedelta(hours=1), TIMEFRAME_H4: timedelta(hours=4), TIMEFRAME_D1: timedelta(days=1)}
