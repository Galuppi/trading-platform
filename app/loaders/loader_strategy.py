'''"""This module provides functions including strategy_registry_config, discover_strategies, strategy_registry_class."""'''
import importlib
import yaml
import logging
