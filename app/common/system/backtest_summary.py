'''"""This module defines classes related to BacktestSummary."""'''
import json
...
class BacktestSummary:
    ...
    def __init__(self: Any, backtest_config: BacktestConfig) -> Any:
    ...
    def set_time_range(self: Any, start: datetime, end: datetime) -> Any:
        self.summary['start_time'] = start.strftime(DATETIME_FORMAT)
        self.summary['end_time'] = end.strftime(DATETIME_FORMAT)

    def set_deposit_info(self: Any, deposit: float, profit: float) -> Any:
    ...
    def set_strategy_metrics(self: Any, trades: list) -> Any:
    ...
    def update_total_profit(self: Any, profit: float, trade_date: Optional[str]=None) -> None:
