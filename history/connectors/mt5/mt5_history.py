'''"""This module defines classes related to Mt5History."""'''
import MetaTrader5 as mt5
import pandas as pd
import logging
from datetime import datetime, timezone
from dateutil.relativedelta import relativedelta
from history.common.config.constants import TIMEFRAME_M1, TIMEFRAME_M5, TIMEFRAME_M15, TIMEFRAME_M30, TIMEFRAME_H1, TIMEFRAME_H4, TIMEFRAME_D1
    ...
    def get_historical_data(self: Any, symbol: str, timeframe: str, start_date: datetime, end_date: datetime) -> pd.DataFrame:
        ...
        while current_start < end_date:
            ...
            if rates is None or len(rates) == 0:
                logger.warning(f'No data returned for {symbol} — {start_utc.date()} to {end_utc.date()}')
            else:
