...
robocopy "%SOURCE%\app" "%DEST%\app" /E /NFL /NDL /NJH /NJS /NC /NS >nul
robocopy "%SOURCE%\history" "%DEST%\history" /E /NFL /NDL /NJH /NJS /NC /NS >nul

REM Copy configuration and startup scripts
echo Copying configuration files...
copy /Y "%SOURCE%\.env" "%DEST%\.env" >nul
